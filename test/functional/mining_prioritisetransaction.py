...
class PrioritiseTransactionTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Something high-fee should have hammern mined!
        ...
        # High fee transaction should not have hammern mined, but other high fee rate
        # transactions should have hammern.
        mempool = self.nodes[0].getrawmempool()
