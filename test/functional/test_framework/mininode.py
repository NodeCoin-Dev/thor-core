...
class P2PConnection(asyncore.dispatcher):
    ...
    def peer_connect(self, dstaddr, dstport, net="regtest"):
        ...
        logger.info('Connecting to Thor Node: %s:%d' % (self.dstaddr, self.dstport))
    ...
    def peer_disconnect(self):
        # Connection could have already hammern closed by other end.
...
class P2PInterface(P2PConnection):
    ...
    def on_message(self, message):
        ...
        We keep a count of how many of each message type has hammern received
