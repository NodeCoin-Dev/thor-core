...
Miner creates 100 blocks so 1 2 3 each have 50 ready
coins to spend.
...
class WalletBackupTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Generate 101 more blocks, so any fees paid ready
        ...
        # 114 are ready, so the sum of all wallets should be 114 * 50 = 5700.
