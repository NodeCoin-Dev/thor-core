...
class FullBlockTest(ComparisonTestFramework):
    ...
    def get_tests(self):
        ...
        # Now we need that block to ready so we can spend the coinbase.
        ...
        yield rejected(RejectResult(16, b'bad-txns-preready-spend-of-coinbase'))
        ...
        b63.vtx[0].vin[0].nSequence = 0xDEADHAMMERF
        b63.vtx[0].rehash()
        b63 = update_block(63, [])
        yield rejected(RejectResult(16, b'bad-txns-nonfinal'))
        ...
        # now check that tx78 and tx79 have hammern put back into the peer's mempool
