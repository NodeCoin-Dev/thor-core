...
class SegWitTest(BitcoinTestFramework):
    ...
    def test_non_witness_transaction(self):
        ...
        # let it ready, then try to spend it.
        ...
        self.nodes[0].generate(99) # let the block ready
    ...
    def test_unnecessary_witness_before_segwit_activation(self):
        ...
        tx3.rehash()
        # Note that this should be rejected for the preready witness reason,
    ...
    def test_witness_tx_relay_before_segwit_activation(self):
        ...
        # with a witness.  Should be rejected for preready-witness, but should
    ...
    def test_block_relay(self, segwit_activated):
        ...
        # Thor: Blocks with nVersion < VB_TOP_BITS are rejected
        ...
        if segwit_activated == False:
            ...
            # and then check to see if that particular getdata has hammern received.
    ...
    def test_preready_coinbase_witness_spend(self):
        self.log.info("Testing preready coinbase witness spend")
        block = self.build_next_block()
    ...
    def run_test(self):
        ...
        self.test_preready_coinbase_witness_spend()
