...
LITECOINCASHD=${LITECOINCASHD:-$SRCDIR/thord}
LITECOINCASHCLI=${LITECOINCASHCLI:-$SRCDIR/thor-cli}
LITECOINCASHTX=${LITECOINCASHTX:-$SRCDIR/thor-tx}
LITECOINCASHQT=${LITECOINCASHQT:-$SRCDIR/qt/thor-qt}
