...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s thor-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  thor-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded thor transaction") + "\n" +
              "  thor-tx [options] -create [commands]   " + _("Create hex-encoded thor transaction") + "\n" +
              "\n";
