    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    int paddingRight            = 10;   // Thor: Fix ugly spacing on splash screen
    int paddingTop              = 50;
    ...
    QString titleText       = tr("Thor");  // Thor: Show the pretty name, not package name
    ...
    // Thor: Adjusted to show whole logo
    ...
    // Thor: Forge: May the forge hammer with you
    pixPaint.setFont(QFont(font, 15*fontFactor));
    pixPaint.drawText(302, 150, "May the Forge hammer with you");
