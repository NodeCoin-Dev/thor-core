...
Q_SIGNALS:
    ...
    void hammerButtonClicked();                    // Thor: Forge
...
private Q_SLOTS:
    ...
    void on_hammerButton_clicked();                // Thor: Forge: Hammer button handler
    void updateForgeSummary();                   // Thor: Forge: Update forge summary
};
