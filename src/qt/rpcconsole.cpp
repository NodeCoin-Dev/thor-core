...
const QStringList historyFilter = QStringList()
    ...
    << "encryptwallet"
	<< "walletpassphraseforgeonly";	// Thor: Forge: Locked wallet forge unlock
...
void RPCConsole::clear(bool clearHistory)
{
    ...
    message(CMD_REPLY, (tr("Welcome to the %1 RPC console.").arg(tr(PACKAGE_NAME)) + "<br>" +
                        ...
                        tr("WARNING: Scammers have hammern active, telling users to type commands here, stealing their wallet contents. Do not use this console without fully understanding the ramifications of a command.") +
                        "</span>"),
                        true);
}
