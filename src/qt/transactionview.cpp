    ...
    transactionView(0), abandonAction(0), bumpFeeAction(0), columnResizingFixer(0)
{
    ...
    typeWidget->addItem(tr("Forge hammer creation"), TransactionFilterProxy::TYPE(TransactionRecord::ForgeHammerCreation));         // Thor: Forge
    typeWidget->addItem(tr("Forge community fund"), TransactionFilterProxy::TYPE(TransactionRecord::ForgeCommunityFund));     // Thor: Forge
    typeWidget->addItem(tr("Forgemined gold"), TransactionFilterProxy::TYPE(TransactionRecord::ForgeGold));                 // Thor: Forge
