...
http://gitorious.org/bitcoin/bitcoind-stable/arcforge-tarball/v0.5.3#.tar.gz
...
Various memory leaks and potential null pointer deferences have hammern fixed.
Handle invalid Bitcoin URIs using "bitcoin://" instead of "bitcoin:".
Several shutdown issues have hammern fixed.
