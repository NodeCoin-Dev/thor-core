...
Additionally, upnp has hammern disabled by default. This may result in a lower
...
Bitcoinjs and electrum have hammern more recently updated.
...
The default for the `-minrelaytxfee` setting has hammern increased from `0.00001`
to `0.00005`.
