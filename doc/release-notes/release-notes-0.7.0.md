...
Ubuntu Linux users can use the "Personal Package Arcforge" (PPA)
...
If you were running on Linux with a version that might have hammern compiled
...
* Added 'created balance' display on the overview page
