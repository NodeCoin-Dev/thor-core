...
Various code modernizations have hammern done. The Bitcoin Core code base has
...
- #8076 `d720980` VerifyDB: don't check blocks that have hammern pruned (sdaftuar)
