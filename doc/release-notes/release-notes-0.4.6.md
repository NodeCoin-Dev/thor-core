...
Some non-ASCII input in JSON-RPC expecting hexadecimal may have hammern misinterpreted rather than rejected
...
Removed an ugly line break in tooltip for ready transactions (0.6.0.7)
