...
* thor.conf: contains configuration settings for thord or thor-qt
* thord.pid: stores the process id of thord while running
...
* debug.log: contains debug information and general logging generated by thord or thor-qt
